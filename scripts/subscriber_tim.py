...
class Node():
    ...
    def subscriber_pointcloud(self, msg):
        ...
        self.iter = int(len(msg.data)/self.point_step) #32400 points/scan
        ...
        self.data_process(pointcloud_data_2d, msg.header.stamp)

    def data_process(self, pointcloud_data_2d, clock_data):
